...
int main( int argc, char** argv )
{
	...
	vector<vector<int>> count;
		...
		if(i==0)
		{
			...
			lesion.insert(lesion.end(), {923,3605,391,4242,414,3422,1063,6350,1500,928,2538,1469,4797,619});
			mp.insert(mp.end(), {Point(377, 843),Point(315, 795),Point(192, 590),Point(624, 575),Point(526, 466),Point(412, 469),Point(553, 419),Point(308, 433),Point(350,415),Point(671, 348),Point(1035, 357),Point(1024, 263),Point(1088, 216),Point(325, 88)});
			allRadii.insert(allRadii.end(), {21,51,14,52,13,40,25,74,22,35,27,56,17,19});
			allCenters.insert(allCenters.end(), {Point2f(378.5, 842.75),Point2f(311.5, 794),Point2f(191.975, 590.975),Point2f(619.79, 572.441),Point2f(526, 466),Point2f(416.5, 469.5),Point2f(549.17, 420.409),Point2f(311.5, 426),Point2f(350,415),Point2f(672, 350),Point2f(1036.5, 358.5),Point2f(1024, 264.5),Point2f(1089.5, 216),Point2f(325.5, 85.5)});
		}		
