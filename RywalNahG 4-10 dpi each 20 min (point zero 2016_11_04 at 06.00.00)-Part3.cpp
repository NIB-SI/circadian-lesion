...
int main( int argc, char** argv )
{
	...
	vector<vector<int>> count;
		...
		if(i==0)
		{
			...
			lesion.insert(lesion.end(), {2238,8005,2771,7443,1190,5340,2420,5360,1284,4712,5726,3736,10756,2096});
			mp.insert(mp.end(), {Point(279, 872),Point(279, 872),Point(112, 648),Point(538, 609),Point(446, 472),Point(265, 502),Point(446, 472),Point(265, 502),Point(265, 502),Point(571, 374),Point(937, 378),Point(987, 212),Point(987, 212),Point(235, 118)});
			allRadii.insert(allRadii.end(), {81,81,37,70,62,105,62,105,105,47,64,59,74,41});
			allCenters.insert(allCenters.end(), {Point2f(279, 872),Point2f(279, 872),Point2f(112, 648),Point2f(538, 609),Point2f(446, 472),Point2f(265, 502),Point2f(446, 472),Point2f(265, 502),Point2f(265, 502),Point2f(571, 374),Point2f(937, 378),Point2f(987, 212),Point2f(987, 212),Point2f(235, 118)});
		}
	...
	for (int i = 0; i < lesion.size(); i++)
	{
		...
		else
		{
			...
			{	
				...
				if(smallest_dist<150) //ignore too far lesions (forget them)
				{
