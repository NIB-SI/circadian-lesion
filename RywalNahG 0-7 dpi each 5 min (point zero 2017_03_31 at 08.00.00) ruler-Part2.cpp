...
int main( int argc, char** argv )
{
	...
	vector<vector<int>> count;
		...
		if(i==0)
		{
			...
			lesion.insert(lesion.end(), {4749,1607,3605,3094,3860,824,3288,1101,2359,2087,542,1827,500,1225,471,360,400,300, 350, 150});
			mp.insert(mp.end(), {Point(214, 803),Point(941, 655),Point(1084, 605),Point(366, 619),Point(342, 413),Point(1157, 317),Point(362, 270),Point(362, 270),Point(839, 246),Point(453, 222),Point(1096, 87),Point(1046, 273),Point(1170, 83),Point(1202, 85),Point(205, 310),Point(566, 470),Point(280, 430), Point(405, 435), Point(1040,560), Point(915, 690)});
			allRadii.insert(allRadii.end(), {45,27,48,37,43,19,66,66,32,32,16,37,25,36,15,16, 10, 8, 7, 5});
			allCenters.insert(allCenters.end(), {Point2f(215.703, 805.324),Point2f(944.662, 655.803),Point2f(1082.32, 594.755),Point2f(369.221, 620.667),Point2f(342.904, 421.117),Point2f(1156.09, 317),Point2f(363, 264.5),Point2f(363, 264.5),Point2f(838.041, 246.245),Point2f(451, 221.5),Point2f(1095.66, 87.3116),Point2f(1041.33, 276.354),Point2f(1170, 83),Point2f(1200.5, 84),Point2f(205.351, 308.507),Point2f(565.5, 471),Point2f(265, 430), Point2f(400, 435), Point2f(1040,560), Point2f(915, 690)});
		}
	...
	for (int i = 0; i < lesion.size(); i++)
	{
		...
		else
		{
			...
			{	
				...
				if(smallest_dist<100) //ignore too far lesions (forget them)
				{
