...
int main( int argc, char** argv )
{
	...
	vector<vector<int>> count;
		...
		if(i==0)
		{
			...
			lesion.insert(lesion.end(), {1047,587,1160,1743,1692,1818,2148, 125,150,100,75,125,150,50});
			mp.insert(mp.end(), {Point(1022,777),Point(1161,694),Point(731,580),Point(98,536),Point(153,426),Point(1129,358),Point(1055,198),Point(308,545), Point(196,554),Point(205,570),Point(499,732),Point(670,598),Point(634,424),Point(928,267)});
			allRadii.insert(allRadii.end(), {23,17,38,37,32,45,55,23,13,11,8,17,16,20});
			allCenters.insert(allCenters.end(), {Point2f(1022, 777),Point2f(1161, 694),Point2f(731, 580),Point2f(98, 536),Point2f(153, 426),Point2f(1129, 358),Point2f(1055,198),Point2f(308,545), Point2f(196,554),Point2f(205,570),Point2f(499,732),Point2f(670,598),Point2f(634,424),Point2f(928,267)});
		}		
